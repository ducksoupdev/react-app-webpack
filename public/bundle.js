...
function HelloButton() {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(Button, { onClick: handleClick, text: 'Say Hello' }),
    _react2.default.createElement(GoodbyeButton, null)
  );
}
...
function GoodbyeButton() {
  ...
  return _react2.default.createElement(Button, { onClick: handleClick, text: 'Say Goodbye' });
}

(0, _reactDom.render)(_react2.default.createElement(HelloButton, null), document.getElementById('root'));
